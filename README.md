...
1. `supabase/migrations/0001_init.sql` → crea tablas, seguridad (RLS), el bucket
   ...
   `5493415001037`) + productos de ejemplo.
...
> email `rodriadmin@admin.com`, password `Rodri2026`, y marcá **Auto Confirm User**.
...
NEXT_PUBLIC_DEFAULT_WHATSAPP=5493415001037
```
...
- Admin:  http://localhost:3000/admin  (entrar con `rodriadmin@admin.com` / `Rodri2026`)
